...
...;intra         # pattern shorter than pool, so letters can be dropped
......;intra      # pattern longer than pool, so letters can be added
;tent(ed)         # anagram of TENTED that contains ED exactly
```
